...
export const metadata: Metadata = {
  ...
  description:
    'The neutral B2B reference platform, vendor directory, and equipment marketplace for lifting professionals across India, GCC, and West Africa. Technical specs, ASME B30, FEM standards.',
  keywords: [
    ...
    'overhead crane', 'mobile crane', 'crawler crane', 'lifting gear',
  ],
  openGraph: {
    type: 'website',
    locale: 'en_US',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${jetbrainsMono.variable}`}>
      ...
      <body className="font-sans antialiased bg-white text-steel-900">
        <Toaster
          position="top-right"
          toastOptions={{
            duration: 4000,
