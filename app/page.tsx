                ...
                <div key={v.id} className="bg-white hover:bg-slate-50 transition-colors p-5 flex items-start gap-5 group">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {v.equipment_categories?.slice(0, 4).map(cat => (
                        <span key={cat} className="badge badge-free text-xs">{cat}</span>
                      ))}
                    </div>
                  </div>
                  <button className="btn-ghost btn-sm flex-shrink-0 hidden sm:flex" onClick={() => {}}>
                    Get Quote
                  </button>
                </div>
              )) : (
                ...
                [
                  ...
                  <div key={i} className="bg-white hover:bg-slate-50 transition-colors p-5 flex items-start gap-5 group">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {v.cats.map(cat => <span key={cat} className="badge badge-free text-xs">{cat}</span>)}
                      </div>
                    </div>
                    <button className="btn-ghost btn-sm flex-shrink-0 hidden sm:flex">Get Quote</button>
                  </div>
                ))
              )}
            </div>
